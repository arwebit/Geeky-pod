...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 21, 2024 at 09:46 AM
...
(1, 'https://forms.gle/q3KF35iJDZhnk5Em9', 'manashnita2011@gmail.com', 'Agartala, Tripura', 9962418187, 'https://www.instagram.com/thegeekypod/', 'https://www.youtube.com/@thegeekypod', 'https://open.spotify.com/show/5L7wYgEy2skYWp0rJosHXq?si=8ae92170a5b347f1');
...
(2, 'sliders/20240815114330.jpg', '', '', '', '', 'yes'),
(3, 'sliders/20240815114413.jpg', '', '', '', '', 'yes');
...
--
ALTER TABLE `episode_lists`
  MODIFY `episode_id` bigint(38) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
